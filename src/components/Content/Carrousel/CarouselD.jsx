    ...
    <>
      ...
      <div className="w-[100%] flex justify-around gap-5 xl:gap-0">
        ...
        <img
          ...
          className={`w-[21%] xl:w-[18%] rounded-xl bg-cover bg-no-repeat bg-center cursor-pointer border-2 ${selectorImage === "image-product-2" ? "border-[#e97a2b] opacity-50" : "hover:border-[#e97a2b] hover:opacity-50"}`}
        />
        <img
          src="/ecommerce-product-page-main/image-product-3-thumbnail.jpg"
          alt="producto03"
          onClick={()=>setSelectorImage("image-product-3")}
          className={`w-[21%] xl:w-[18%] rounded-xl bg-cover bg-no-repeat bg-center cursor-pointer border-2 ${selectorImage === "image-product-3" ? "border-[#e97a2b] opacity-50" : "hover:border-[#e97a2b] hover:opacity-50"}`}
        />
        <img
          src="/ecommerce-product-page-main/image-product-4-thumbnail.jpg"
          alt="producto04"
          onClick={()=>setSelectorImage("image-product-4")}
          className={`w-[21%] xl:w-[18%] rounded-xl bg-cover bg-no-repeat bg-center cursor-pointer border-2 ${selectorImage === "image-product-4" ? "border-[#e97a2b] opacity-50" : "hover:border-[#e97a2b] hover:opacity-50"}`}
        />
      </div>
    </>
  );
